          ...
          <div class="box box-default banking-box mb-0">
            ...
            <div class="box-footer clearfix">
              <?php if (user_group_id() == 1 || has_permission('access', 'create_sell_invoice')) : ?>
                <a href="<?php echo root_url();?>/admin/pos.php" class="btn btn-xs btn-primary btn-flat"><span class="fa fa-fw fa-plus"></span> <?php echo trans('button_add_sales'); ?></a>
              <?php endif; ?>
              <?php if (user_group_id() == 1 || has_permission('access', 'read_sell_list')) : ?>
                <a href="<?php echo root_url();?>/admin/invoice.php" class="btn btn-xs btn-primary btn-flat"><span class="fa fa-fw fa-list"></span> <?php echo trans('button_list_sales'); ?></a>
              <?php endif; ?>
            </div>
          </div>
        </div>
